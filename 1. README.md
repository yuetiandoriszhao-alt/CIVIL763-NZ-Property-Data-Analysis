...
|----------------|-------------|
| **1. README.html** | Project overview, data sources, dependencies, reproducibility. |
| **2. Code_Doris Zhao.pdf** | Main notebook with analysis (Patterns 1–3). |
...
> *Note: The original files are not uploaded here due to size restrictions; download links are provided instead.*
